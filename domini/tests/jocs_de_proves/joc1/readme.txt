...
Els fitxers de dades són els d'exemple proveits pel professorat amb el corresponent arxiu de queries:
    inputqueries.txt, items.csv, ratigs.test.known.csv, ratings.test.unknown.csv
