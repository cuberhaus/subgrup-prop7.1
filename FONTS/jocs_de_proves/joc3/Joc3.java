...
public class Joc3 {
    public static void main(String[] args) throws Exception {
        ...
        TaulaCSV taula_items = new TaulaCSV(lector.llegirCSV("../EXE/jocs_de_proves/joc3/items.csv"));
        ...
        TaulaCSV taula_valoracions = new TaulaCSV(lector2.llegirCSV("../EXE/jocs_de_proves/joc3/ratings.test.known.csv"));
        ...
        TaulaCSV taula_valoracions_un = new TaulaCSV(lector3.llegirCSV("../EXE/jocs_de_proves/joc3/ratings.test.unknown.csv"));
        ...
        MetodeRecomanadorHibrid recomanadorHibrid = new MetodeRecomanadorHibrid(usuaris, items, valoracions);
        File inputQueries = new File("../EXE/jocs_de_proves/joc3/inputqueries.txt");
        ...
        for (int i = 0; i < q; ++i) {
            ...
            ConjuntRecomanacions recomanacionsHibrid = recomanadorHibrid.obteRecomanacions(usuari, items_recomanables, val_usuari, Q);
        ...
        System.out.println("Recomanador hibrid:\nDGC mitja: " + totalDCG3/q + ", IDCG mitja: " + totalIDCG3/q +
                ", NDCG mitja: " + totalNDCG3/q);
    }
}
